...
namespace Quarto
{
    public partial class Menu : Form
    {
        ...
        {
            Location = new Point(
                Screen.FromControl(this).WorkingArea.Left + (Screen.FromControl(this).WorkingArea.Width - Size.Width) / 2,
                Screen.FromControl(this).WorkingArea.Top + (Screen.FromControl(this).WorkingArea.Height - Size.Height) / 2
            );
        }
        ...
        {
            string filePath = @"..\..\..\..\..\Szabályzat.html";
